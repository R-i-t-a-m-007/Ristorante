            ...
            <Row>
              <Col className='w-full flex items-center' sm={12} lg={6}>
                <div className='md:ms-10 mt-5'>
                  <h1 className='text-center'>Habibi Welcome to <span className='text-red-700 font-bold'>Ristorante</span></h1>
                ...
                <Row>
                  <Col sm={12} lg={6}>
                    <div className='px-5 mt-3 mb-5'>
                      <h4><i className="fa-solid fa-pepper-hot fa-bounce text-red-700 mt-5"></i><span className='ms-2 font-bold'>Ristorante</span></h4>
                      <h6>
                  ...
                  <Col sm={12} lg={6}>
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3683.9922687065735!2d88.34957221526172!3d22.572646185176866!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a0277045e4e0d11%3A0x5e1e9d70d6d49a25!2sKolkata%2C%20West%20Bengal%2C%20India!5e0!3m2!1sen!2sin!4v1699121356830!5m2!1sen!2sin" 
                    style={{border: '1px', width: '250px', height: '250px'}} 
                    allowfullscreen="" 
                    loading="lazy" 
